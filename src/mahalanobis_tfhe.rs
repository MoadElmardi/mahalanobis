use std::vec;
use tfhe::{prelude::*, FheInt32Id, PublicKey, Tag};
...
//         println!("\nProcessing row {}", i);
//         // Find the pivot
//         // let pivot = matrix.slice(&[i*n..i*n+1]);
...
pub fn main() {
    ...
    // let inverse_decrypted: Vec<u32> = inverse.decrypt(&client_key);
